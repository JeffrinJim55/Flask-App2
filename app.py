...
# General Disease Responses
    ...
    elif any(x in user_input for x in ['hello', 'hi', 'hai','hai doctor','doctor','hey','hey doctor','hai ai doctor','hi doctor','hai ai doctor']):
    ...
    elif any(x in user_input for x in ['ok', 'good', 'tq','great','excellet','thank you ai doctor','tq doctor','thank you doctor','thank a lot','thank you so much','thank you soo much' 'thankyou', 'thank you', 'thanks']):
    ...
    elif any(x in user_input for x in ['throat pain', 'sore throat', 'pain in throat','running nose']):
        return "Stay hydrated by drinking warm water\nGargle with salt water (1/2 teaspoon of salt in a cup of warm water) multiple times a day.\nMix honey with ginger juice to reduce irritation.\nRest your voice and avoid talking excessively.\nIf symptoms persist for more than one day consult a doctor."
